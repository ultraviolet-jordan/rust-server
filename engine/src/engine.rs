...
pub struct Engine {
    ...
    pub core_ops: CoreOps,
    pub math_ops: MathOps,
    pub oc_ops: OcOps,
...
impl Engine {
    pub fn new(cache: CacheProvider) -> Engine {
        return Engine {
            cache,
            core_ops: CoreOps::new(),
            math_ops: MathOps::new(),
            oc_ops: OcOps::new(),
...
impl ScriptRunner for Engine {
    fn push_script<'script>(&'script self, code: &ScriptOpcode, state: &mut ScriptState<'script>) {
        ...
        match code {
            ...
            ScriptOpcode::PushConstantInt => self.core_ops.push(self, state, code),
            ScriptOpcode::PushVarp => self.core_ops.push(self, state, code),
            ScriptOpcode::PopVarp => self.core_ops.push(self, state, code),
            ScriptOpcode::PushConstantString => self.core_ops.push(self, state, code),
            ScriptOpcode::PushVarn => self.core_ops.push(self, state, code),
            ScriptOpcode::PopVarn => self.core_ops.push(self, state, code),
            ScriptOpcode::Branch => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchNot => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchEquals => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchLessThan => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchGreaterThan => self.core_ops.push(self, state, code),
            ScriptOpcode::PushVars => self.core_ops.push(self, state, code),
            ScriptOpcode::PopVars => self.core_ops.push(self, state, code),
            ScriptOpcode::Return => self.core_ops.push(self, state, code),
            ScriptOpcode::GoSub => self.core_ops.push(self, state, code),
            ScriptOpcode::Jump => self.core_ops.push(self, state, code),
            ScriptOpcode::Switch => self.core_ops.push(self, state, code),
            ScriptOpcode::PushVarbit => self.core_ops.push(self, state, code),
            ScriptOpcode::PopVarbit => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchLessThanOrEquals => self.core_ops.push(self, state, code),
            ScriptOpcode::BranchGreaterThanOrEquals => self.core_ops.push(self, state, code),
            ScriptOpcode::PushIntLocal => self.core_ops.push(self, state, code),
            ScriptOpcode::PopIntLocal => self.core_ops.push(self, state, code),
            ScriptOpcode::PushStringLocal => self.core_ops.push(self, state, code),
            ScriptOpcode::PopStringLocal => self.core_ops.push(self, state, code),
            ScriptOpcode::JoinString => self.core_ops.push(self, state, code),
            ScriptOpcode::PopIntDiscard => self.core_ops.push(self, state, code),
            ScriptOpcode::PopStringDiscard => self.core_ops.push(self, state, code),
            ScriptOpcode::GoSubWithParams => self.core_ops.push(self, state, code),
            ScriptOpcode::JumpWithParams => self.core_ops.push(self, state, code),
            ScriptOpcode::PushVarcInt => self.core_ops.push(self, state, code),
            ScriptOpcode::PopVarcInt => self.core_ops.push(self, state, code),
            ScriptOpcode::DefineArray => self.core_ops.push(self, state, code),
            ScriptOpcode::PushArrayInt => self.core_ops.push(self, state, code),
            ScriptOpcode::PopArrayInt => self.core_ops.push(self, state, code),
            ScriptOpcode::EndCoreOps => self.core_ops.push(self, state, code),
            ...
            ScriptOpcode::OcCategory => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcCert => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcCost => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcDebugname => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcDesc => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcIop => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcMembers => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcName => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcOp => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcParam => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcStackable => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcTradeable => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcUncert => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcWearPos2 => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcWearPos3 => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcWearPos => self.oc_ops.push(self, state, code),
            ScriptOpcode::OcWeight => self.oc_ops.push(self, state, code),
            ...
            ScriptOpcode::AppendNum => self.string_ops.push(state, code),
            ScriptOpcode::Append => self.string_ops.push(state, code),
            ScriptOpcode::AppendSignNum => self.string_ops.push(state, code),
            ScriptOpcode::Lowercase => self.string_ops.push(state, code),
            ScriptOpcode::TextGender => self.string_ops.push(state, code),
            ScriptOpcode::ToString => self.string_ops.push(state, code),
            ScriptOpcode::Compare => self.string_ops.push(state, code),
            ScriptOpcode::TextSwitch => self.string_ops.push(state, code),
            ScriptOpcode::AppendChar => self.string_ops.push(state, code),
            ScriptOpcode::StringLength => self.string_ops.push(state, code),
            ScriptOpcode::SubString => self.string_ops.push(state, code),
            ScriptOpcode::StringIndexOfChar => self.string_ops.push(state, code),
            ScriptOpcode::StringIndexOfString => self.string_ops.push(state, code),
            // Number ops (4600-4699)
            ScriptOpcode::Add => self.math_ops.push(state, code),
            ScriptOpcode::Sub => self.math_ops.push(state, code),
            ScriptOpcode::Multiply => self.math_ops.push(state, code),
            ScriptOpcode::Divide => self.math_ops.push(state, code),
            ScriptOpcode::Random => self.math_ops.push(state, code),
            ScriptOpcode::RandomInc => self.math_ops.push(state, code),
            ScriptOpcode::Interpolate => self.math_ops.push(state, code),
            ScriptOpcode::AddPercent => self.math_ops.push(state, code),
            ScriptOpcode::SetBit => self.math_ops.push(state, code),
            ScriptOpcode::ClearBit => self.math_ops.push(state, code),
            ScriptOpcode::TestBit => self.math_ops.push(state, code),
            ScriptOpcode::Modulo => self.math_ops.push(state, code),
            ScriptOpcode::Pow => self.math_ops.push(state, code),
            ScriptOpcode::InvPow => self.math_ops.push(state, code),
            ScriptOpcode::And => self.math_ops.push(state, code),
            ScriptOpcode::Or => self.math_ops.push(state, code),
            ScriptOpcode::Min => self.math_ops.push(state, code),
            ScriptOpcode::Max => self.math_ops.push(state, code),
            ScriptOpcode::Scale => self.math_ops.push(state, code),
            ScriptOpcode::BitCount => self.math_ops.push(state, code),
            ScriptOpcode::ToggleBit => self.math_ops.push(state, code),
            ScriptOpcode::SetBitRange => self.math_ops.push(state, code),
            ScriptOpcode::ClearBitRange => self.math_ops.push(state, code),
            ScriptOpcode::GetBitRange => self.math_ops.push(state, code),
            ScriptOpcode::SetBitRangeToInt => self.math_ops.push(state, code),
            ScriptOpcode::SinDeg => self.math_ops.push(state, code),
            ScriptOpcode::CosDeg => self.math_ops.push(state, code),
            ScriptOpcode::Atan2Deg => self.math_ops.push(state, code),
            ScriptOpcode::Abs => self.math_ops.push(state, code),
            // DB ops (7500-7599)
