...
impl ScriptRunner for Engine {
    fn push_script<'script>(&'script self, code: &ScriptOpcode, state: &mut ScriptState<'script>) {
        ...
        match code {
            ...
            ScriptOpcode::PushConstantInt => script_core_ops(self, state, code),
            ScriptOpcode::PushVarp => script_core_ops(self, state, code),
            ScriptOpcode::PopVarp => script_core_ops(self, state, code),
            ScriptOpcode::PushConstantString => script_core_ops(self, state, code),
            ScriptOpcode::PushVarn => script_core_ops(self, state, code),
            ScriptOpcode::PopVarn => script_core_ops(self, state, code),
            ScriptOpcode::Branch => script_core_ops(self, state, code),
            ScriptOpcode::BranchNot => script_core_ops(self, state, code),
            ScriptOpcode::BranchEquals => script_core_ops(self, state, code),
            ScriptOpcode::BranchLessThan => script_core_ops(self, state, code),
            ScriptOpcode::BranchGreaterThan => script_core_ops(self, state, code),
            ScriptOpcode::PushVars => script_core_ops(self, state, code),
            ScriptOpcode::PopVars => script_core_ops(self, state, code),
            ScriptOpcode::Return => script_core_ops(self, state, code),
            ScriptOpcode::GoSub => script_core_ops(self, state, code),
            ScriptOpcode::Jump => script_core_ops(self, state, code),
            ScriptOpcode::Switch => script_core_ops(self, state, code),
            ScriptOpcode::PushVarbit => script_core_ops(self, state, code),
            ScriptOpcode::PopVarbit => script_core_ops(self, state, code),
            ScriptOpcode::BranchLessThanOrEquals => script_core_ops(self, state, code),
            ScriptOpcode::BranchGreaterThanOrEquals => script_core_ops(self, state, code),
            ScriptOpcode::PushIntLocal => script_core_ops(self, state, code),
            ScriptOpcode::PopIntLocal => script_core_ops(self, state, code),
            ScriptOpcode::PushStringLocal => script_core_ops(self, state, code),
            ScriptOpcode::PopStringLocal => script_core_ops(self, state, code),
            ScriptOpcode::JoinString => script_core_ops(self, state, code),
            ScriptOpcode::PopIntDiscard => script_core_ops(self, state, code),
            ScriptOpcode::PopStringDiscard => script_core_ops(self, state, code),
            ScriptOpcode::GoSubWithParams => script_core_ops(self, state, code),
            ScriptOpcode::JumpWithParams => script_core_ops(self, state, code),
            ScriptOpcode::PushVarcInt => script_core_ops(self, state, code),
            ScriptOpcode::PopVarcInt => script_core_ops(self, state, code),
            ScriptOpcode::DefineArray => script_core_ops(self, state, code),
            ScriptOpcode::PushArrayInt => script_core_ops(self, state, code),
            ScriptOpcode::PopArrayInt => script_core_ops(self, state, code),
            ScriptOpcode::EndCoreOps => script_core_ops(self, state, code),
            ...
            ScriptOpcode::OcCategory => script_oc_ops(self, state, code),
            ScriptOpcode::OcCert => script_oc_ops(self, state, code),
            ScriptOpcode::OcCost => script_oc_ops(self, state, code),
            ScriptOpcode::OcDebugname => script_oc_ops(self, state, code),
            ScriptOpcode::OcDesc => script_oc_ops(self, state, code),
            ScriptOpcode::OcIop => script_oc_ops(self, state, code),
            ScriptOpcode::OcMembers => script_oc_ops(self, state, code),
            ScriptOpcode::OcName => script_oc_ops(self, state, code),
            ScriptOpcode::OcOp => script_oc_ops(self, state, code),
            ScriptOpcode::OcParam => script_oc_ops(self, state, code),
            ScriptOpcode::OcStackable => script_oc_ops(self, state, code),
            ScriptOpcode::OcTradeable => script_oc_ops(self, state, code),
            ScriptOpcode::OcUncert => script_oc_ops(self, state, code),
            ScriptOpcode::OcWearPos2 => script_oc_ops(self, state, code),
            ScriptOpcode::OcWearPos3 => script_oc_ops(self, state, code),
            ScriptOpcode::OcWearPos => script_oc_ops(self, state, code),
            ScriptOpcode::OcWeight => script_oc_ops(self, state, code),
            ...
            ScriptOpcode::AppendNum => script_string_ops(state, code),
            ScriptOpcode::Append => script_string_ops(state, code),
            ScriptOpcode::AppendSignNum => script_string_ops(state, code),
            ScriptOpcode::Lowercase => script_string_ops(state, code),
            ScriptOpcode::TextGender => script_string_ops(state, code),
            ScriptOpcode::ToString => script_string_ops(state, code),
            ScriptOpcode::Compare => script_string_ops(state, code),
            ScriptOpcode::TextSwitch => script_string_ops(state, code),
            ScriptOpcode::AppendChar => script_string_ops(state, code),
            ScriptOpcode::StringLength => script_string_ops(state, code),
            ScriptOpcode::SubString => script_string_ops(state, code),
            ScriptOpcode::StringIndexOfChar => script_string_ops(state, code),
            ScriptOpcode::StringIndexOfString => script_string_ops(state, code),
            // Number ops (4600-4699)
            ScriptOpcode::Add => script_math_ops(state, code),
            ScriptOpcode::Sub => script_math_ops(state, code),
            ScriptOpcode::Multiply => script_math_ops(state, code),
            ScriptOpcode::Divide => script_math_ops(state, code),
            ScriptOpcode::Random => script_math_ops(state, code),
            ScriptOpcode::RandomInc => script_math_ops(state, code),
            ScriptOpcode::Interpolate => script_math_ops(state, code),
            ScriptOpcode::AddPercent => script_math_ops(state, code),
            ScriptOpcode::SetBit => script_math_ops(state, code),
            ScriptOpcode::ClearBit => script_math_ops(state, code),
            ScriptOpcode::TestBit => script_math_ops(state, code),
            ScriptOpcode::Modulo => script_math_ops(state, code),
            ScriptOpcode::Pow => script_math_ops(state, code),
            ScriptOpcode::InvPow => script_math_ops(state, code),
            ScriptOpcode::And => script_math_ops(state, code),
            ScriptOpcode::Or => script_math_ops(state, code),
            ScriptOpcode::Min => script_math_ops(state, code),
            ScriptOpcode::Max => script_math_ops(state, code),
            ScriptOpcode::Scale => script_math_ops(state, code),
            ScriptOpcode::BitCount => script_math_ops(state, code),
            ScriptOpcode::ToggleBit => script_math_ops(state, code),
            ScriptOpcode::SetBitRange => script_math_ops(state, code),
            ScriptOpcode::ClearBitRange => script_math_ops(state, code),
            ScriptOpcode::GetBitRange => script_math_ops(state, code),
            ScriptOpcode::SetBitRangeToInt => script_math_ops(state, code),
            ScriptOpcode::SinDeg => script_math_ops(state, code),
            ScriptOpcode::CosDeg => script_math_ops(state, code),
            ScriptOpcode::Atan2Deg => script_math_ops(state, code),
            ScriptOpcode::Abs => script_math_ops(state, code),
            // DB ops (7500-7599)
